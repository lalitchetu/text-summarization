...
public class SentenceManager {
    ...
    private double getSentenceWeight(Sentence sentence) {
        ...
        double weight = ((Constants.ALPFA) * (getIndividualWordWeight(sentence)) + (Constants.BETA) * (getThemeWordWeight(sentence))
                +
                // (Constants.GAMA)*(getTitleWordWeight(sentence))+
                (Constants.DELTA) * (getWeightDueToSRI(sentence)) + (Constants.THITHA) * (getWeightDueToCuePhrase(sentence)) + (Constants.PHAYI)
                * (getWeightDueToLocation(sentence)) + (Constants.OMWEGA) * (getWeightDueToProperNoun(sentence)));
    ...
    public String getTitle() {
         ...
         * .add(jLabel4) .add(18,18,18) .add(cmbSummarySize,
         * GroupLayout.PREFERRED_SIZE, 142,GroupLayout.PREFERRED_SIZE)
         * .add(32,32,32) .add(btnSummarize,GroupLayout.PREFERRED_SIZE,114,
         * GroupLayout.PREFERRED_SIZE) .addContainerGap(18,Short.MAX_VALUE)) );
         */
        /*
         * jPanel1Layout.setVerticalGroup(
         * jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
         * .add(jPanel1Layout.createSequentialGroup() .add(28,28,28)
         * 
         * 
         * .add(
         * jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
         * .add(jLabel4) .add(cmbSummarySize,GroupLayout.PREFERRED_SIZE,
         * GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
         * .add(btnSummarize)) .addContainerGap(GroupLayout.DEFAULT_SIZE,
         * Short.MAX_VALUE)) );
         * 
         * 
         ...
         * .add(jPanel1,GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
         * GroupLayout.PREFERRED_SIZE)
         * .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
         * .add(txtSaveFile,GroupLayout.PREFERRED_SIZE,223,
         * GroupLayout.PREFERRED_SIZE)
         * .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED,
         * GroupLayout.DEFAULT_SIZE,Short.MAX_VALUE) .add(jButton2))
         * .add(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
         * .add(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
         * .add(jScrollPanel1, GroupLayout.DEFAULT_SIZE, 323,Short.MAX_VALUE)
         * .add(jLabel2, GroupLayout.PREFERRED_SIZE,145,
         * GroupLayout.PREFERRED_SIZE)) .add(46,46,46)
         * .add(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
         * .add(jLabel3,GroupLayout.PREFERRED_SIZE,103,
         * org.jdesktop.layout.GroupLayout.PREFERRED_SIZE) .add(jScrollPanel2,
         * GroupLayout.DEFAULT_SIZE, 329,Short.MAX_VALUE)))) .addContainerGap()
         * ); layout.setVerticalGROUP(
         * layout.createParallelGroup(GroupLayout.Alignment.LEADING)
         * .add(layout.createSequentialGroup() .addContainerGap()
         * .add(layout.createParallelGroup(GroupLayout.Alignment.LEADING) -79
         * .add(jPanel1,GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
         * GroupLayout.PREFERRED_SIZE) .add(layout.createSequentialGroup()
         * .add(25,25,25)
         * .add(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
         * .add(txtSaveFile,GroupLayout.PREFERRED_SIZE,
         * GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
         * .add(jButton2)))) .add(25,25,25)
         * .add(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
         * .add(jLabel2) .add(jLabel3))
         * .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
         * .add(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
         * .add(jScrollPane1,GroupLayout.DEFAULT_SIZE, 307,Short.MAX_VALUE)
         * .add(jScrollPane2,GroupLayout.DEFAULT_SIZE, 307,Short.MAX_VALUE))) );
         */
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {
         ...
         * fileChooser.getSelectedFile(); String
         * inputText=FileUtil.getContentFromFile(file.getAbsolutePath());
    ...
    private void btnSummarizeActionPerformed(java.awt.event.ActionEvent evt) {
        // GEN-FIRST:event_btnSummarizeActionPerformed
        ...
        if (summaryType.equalsIgnoreCase("Large")) {
            ...
            System.out.println("moderate summary");
            ConfigUtil.setSummarySize(40);

        } else if (summaryType.equalsIgnoreCase("Small")) {
            System.out.println(" small summary");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
         ...
         * File file = fileChooser.getSelectedFile(); mSaveFilePath =
    ...
    public void displaySummary(String SummarizedText) {
