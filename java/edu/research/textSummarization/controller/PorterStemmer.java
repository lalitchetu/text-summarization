...
public class PorterStemmer {
    public String stem(String str){
        ...
        if(str.length()>0){
        //over 48
        //all characters must be in letters
       ...
       //(m>0)EED->EE
        if(str.endsWith("eed")) {
        if(stringMeasure(str.substring(0,str.length() - 1)) >0);
       else
        return str;
       //(*v*) ED ->
       ...
       return str + "e";
         ...
         (!(str.endsWith("I")|| str.endsWith("s") ||str.endsWith("z")))){
       return str.substring(0,str.length() - 1);
       ...
       if(false){
            //(m>0) ICATE-> IC
       }else if((str.endsWith("icate"))&&(stringMeasure(str.substring(0,str.length() - 3))>0)){
       return str.substring(0,str.length() - 3);
       //(m>0) ATIVE-> 
       }else if((str.endsWith("active"))&&(stringMeasure(str.substring(0,str.length() - 5))>0)){
       ...
       //(m>1 and *d and *L) -> 
        if(str.endsWith("1")&& endsWithDoubleConsonent(str) && (stringMeasure(str.substring(0,str.length() - 1))>1)) {
        return str.substring(0,str.length() - 1);
       } else {
        return str;
       }
       ...
       */
       ...
       if(c== str.charAt(str.length() - 2));
         if(!conatinsVowel(str.substring(str.length()) - 2)) {
        return true;
       }
       return false;
       } // end function
